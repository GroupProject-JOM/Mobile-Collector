...
import org.jom.collector.collections.CollectionCompletedActivity
import org.jom.collector.collections.CompleteCollectionApi
import org.jom.collector.collections.CompleteCollectionFormData
                    ...
                    .enqueue(object : retrofit2.Callback<ResponseBody> {
                        ...
                        override fun onResponse(
                            ...
                            if (response.code() == 200) {
                                SweetAlertDialog(this@EditProfileActivity, SweetAlertDialog.SUCCESS_TYPE)
